...
**DiGi.ComputeSharp** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.ComputeSharp.Geometry](DiGi.ComputeSharp.Geometry)** (Path: `DiGi.ComputeSharp\DiGi.ComputeSharp.Geometry`)
* **[DiGi.ComputeSharp.Test](DiGi.ComputeSharp.Test)** (Path: `DiGi.ComputeSharp\DiGi.ComputeSharp.Test`)
* **[DiGi.ComputeSharp](DiGi.ComputeSharp)** (Path: `DiGi.ComputeSharp\DiGi.ComputeSharp`)
