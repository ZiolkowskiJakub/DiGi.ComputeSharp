...
namespace DiGi.ComputeSharp.Legacy
{
    ...
    {
        public static List<LineIntersectionResult> LineIntersectionResults(this Line3 line, IEnumerable<Legacy.Classes.Triangle3> triangles, float tolerance = Tolerance.Distance)
        {
            if(triangles == null)
            {
                return null;
        ...
        public static List<LineIntersectionResult> LineIntersectionResults(this IEnumerable<Line3> lines, IEnumerable<Legacy.Classes.Triangle3> triangles, float tolerance = Tolerance.Distance)
        {
            if (triangles == null)
            {
                return null;
